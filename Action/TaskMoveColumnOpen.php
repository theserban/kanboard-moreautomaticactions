 ...
 */
class TaskMoveColumnOpen extends Base
{
    /**
    ...
    {
        return t('M.A.A: Move the task to another column when open');
    }
    ...
    {
        return $data['task']['column_id'] != $this->getParam('dest_column_id') && $data['task']['is_active'] == 1;
    }
}
